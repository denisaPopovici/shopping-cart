...
public class MailMessage {
	...
	private static final String closeHtml = "</html>";
	private static final String openHtml = "<html>";
	private static final String brString = ",<br/><br/>";
	private static final String brStringNoComma = "<br/><br/>";
	private static final String body = "<body>";
	private static final String bodyClosed = "</body>";
	private static final String hey = "Hey ";
	private static final String paragraph = "<p>";
	private static final String paragraphClosed = "</p>";
	private static final String gladMessage = "We are glad that you shop with Ellison Electronics!";
	private static final String tyMessage = "Thanks for shopping with us!<br/><br/>";
	...
	public static void registrationSuccess(String emailId, String name) {
		...
		String htmlTextMessage = closeHtml + body
				...
				+ "Have a good day!<br>" + bodyClosed + closeHtml;
		try {
	...
	public static void transactionSuccess(String recipientEmail, String name, String transId, double transAmount) {
		...
		String htmlTextMessage = openHtml + body + paragraph + hey + name + brString
				+ gladMessage + brStringNoComma
	...
	public static void productAvailableNow(String recipientEmail, String name, String prodName, String prodId) {
		...
		String htmlTextMessage = openHtml + body + paragraph + hey + name + brString
				...
				+ prodName + font + brStringNoComma + tyMessage
